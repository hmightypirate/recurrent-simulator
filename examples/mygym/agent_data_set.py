...
Picked from the deep-q-rl project https://github.com/spragunr/deep_q_rl
...
actions, and rewards.
    ...
    def phi(self, img):
        ...
        phi = np.empty((self.phi_length, self.height, self.width),
                       dtype='float32')
    ...
    def pick_consecutive_batch(self, batch_size, pick_end_state=False):
        """ Pick a consecutive batch of samples """
        # Allocate the response.
        if not pick_end_state:
